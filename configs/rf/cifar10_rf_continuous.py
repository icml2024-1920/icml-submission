...
def get_config():
  ...
  training.reflow_mode = 'train_reflow' # 'gen_reflow' or 'train_reflow' or 'train_distill'.
  training.import_torch = 'RF-Checkpoints/CIFAR10/RF-1/checkpoint_8.pth'
  training.import_flax_baseline = 'none'
